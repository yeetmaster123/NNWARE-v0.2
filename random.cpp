...
#if defined(_DEBUG)
#define _RNG_ASSERT(_Ex, _Msg) ((_Ex) ? (void)0 \
	: (_STD _Debug_message(L ## _Msg, __FILEW__, __LINE__), _SCL_SECURE_INVALID_PARAMETER(_Msg)))
#else /* defined(_DEBUG) */
...
#define _RNG_REQUIRE_INTTYPE(_RandType, _CheckedType) \
	static_assert(_Is_any_of_v<_CheckedType, \
...
// STRUCT TEMPLATE _Enable_if_seed_seq
template<class _Seed_seq,
	class _Self,
	class _Engine = _Self>
	struct _Enable_if_seed_seq
	: enable_if<
	!is_convertible_v<decay_t<_Seed_seq>, typename _Self::result_type>
	&& !is_same_v<decay_t<_Seed_seq>, _Self>
	&& !is_same_v<decay_t<_Seed_seq>, _Engine>>
...
public:
	...
	_NODISCARD size_t size() const _NOEXCEPT
	{	// get size of seed
		return (_Myvec.size());
	}
...
template<class _Ity,
	...
	_Max_type _Mx>
	struct _Mul_mod
{	// linear congruential generator where _Ty is large enough to
	// hold intermediate result without overflow
	_Mul_mod(_Ty _Val = 0)
		: _Prev(_Val)
	{	// construct
	}
...
template<class _Ty,
	...
	_Max_type _Mx>
	class _Mult_prec
{	// linear congruential generator using multiple precision
	// arithmetic to avoid overflows
public:
...
{	// linear congruential random engine
public:
	...
	template<class _Gen,
		class = typename _Enable_if_seed_seq<_Gen, linear_congruential>::type>
	...
	bool _Equals(const linear_congruential& _Right) const
...
{	// a linear congruential generator random engine
public:
	...
	template<class _Seed_seq,
		class = typename _Enable_if_seed_seq<_Seed_seq, linear_congruential_engine>::type>
	...
	_NODISCARD static constexpr _Uint(min)()
	{	// return minimum possible generated value
		return (_Cx != 0 ? 0 : 1);
	}

	_NODISCARD static constexpr _Uint(max)()
	{	// return maximum possible generated value
		return (_Mx != 0 ? _Mx - 1 : (numeric_limits<_Uint>::max)());
	}
};

// CLASS TEMPLATE _Circ_buf FOR subtract_with_carry,
...
{	// common bits of subtract_with_carry/_01
public:
	...
	template<class _Gen,
		class = typename _Enable_if_seed_seq<_Gen, _Swc_base>::type>
		_Swc_base(_Gen& _Gx)
...
template<class _Ty,
	...
	size_t _Rx,
	class _Swc_Traits>
	_NODISCARD bool operator==(const _Swc_base<_Ty, _Sx, _Rx, _Swc_Traits>& _Left,
...
template<class _Ty,
	...
	size_t _Nw>
	struct _Swc_traits
{	// traits for subtract_with_carry generator
	typedef int _Cy_t;
...
public:
	...
	template<class _Gen,
		class = typename _Enable_if_seed_seq<_Gen, subtract_with_carry>::type>
...
public:
	...
	template<class _Seed_seq,
		class = typename _Enable_if_seed_seq<_Seed_seq, subtract_with_carry_engine>::type>
...
{	// traits for subtract_with_carry_01 generator
	typedef _Ty _Cy_t;
	typedef _Ty _UCy_t;
	typedef _Ty _Mod_t;
...
{	// subtract_with_carry_01 generator
public:
	static constexpr size_t word_size = _Wx;
	...
	template<class _Gen,
		class = typename _Enable_if_seed_seq<_Gen, subtract_with_carry_01>::type>
...
public:
	...
	template<class _Gen,
		class = typename _Enable_if_seed_seq<_Gen, mersenne_twister>::type>
...
public:
	...
	template<class _Seed_seq,
		class = typename _Enable_if_seed_seq<_Seed_seq, mersenne_twister_engine>::type>
...
public:
	...
	template<class _Seed_seq,
		class = typename _Enable_if_seed_seq<_Seed_seq, discard_block, _Engine>::type>
	...
	template<class _Seed_seq,
		class = typename _Enable_if_seed_seq<_Seed_seq, discard_block>::type>
		void seed(_Seed_seq& _Seq)
	...
	_NODISCARD const base_type& base() const _NOEXCEPT
...
{	// discard_block_engine compound engine
public:
	...
	template<class _Seed_seq,
		class = typename _Enable_if_seed_seq<_Seed_seq, discard_block_engine, _Engine>::type>
...
{	// independent_bits_engine compound engine
public:
	...
	template<class _Seed_seq,
		class = typename _Enable_if_seed_seq<_Seed_seq, independent_bits_engine, _Engine>::type>
	...
	template<class _Seed_seq,
		class = typename _Enable_if_seed_seq<_Seed_seq, independent_bits_engine>::type>
		void seed(_Seed_seq& _Seq)
	{	// seed engine from seed sequence
		_Eng.seed(_Seq);
	}

	_NODISCARD const _Engine& base() const _NOEXCEPT
	{	// return const reference to engine
		return (_Eng);
	}
...
{	// shuffle_order_engine compound engine
public:
	static_assert(0 < _Kx,
	...
	template<class _Seed_seq,
		class = typename _Enable_if_seed_seq<_Seed_seq, shuffle_order_engine, _Engine>::type>
	...
	template<class _Seed_seq,
		class = typename _Enable_if_seed_seq<_Seed_seq, shuffle_order_engine>::type>
		void seed(_Seed_seq& _Seq)
	{	// seed engine from seed sequence
		_Eng.seed(_Seq);
		_Init();
...
_NODISCARD inline bool operator==(const bernoulli_distribution& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const geometric_distribution<_Ty>& _Left,
...
{	// poisson distribution with small mean
public:
	typedef double _Ty1;
...
template<class _Ty>
_NODISCARD bool operator==(const poisson_distribution<_Ty>& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const binomial_distribution<_Ty>& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const uniform_real_distribution<_Ty>& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const exponential_distribution<_Ty>& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const normal_distribution<_Ty>& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const gamma_distribution<_Ty>& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const weibull_distribution<_Ty>& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const extreme_value_distribution<_Ty>& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const lognormal_distribution<_Ty>& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const chi_squared_distribution<_Ty>& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const cauchy_distribution<_Ty>& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const fisher_f_distribution<_Ty>& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const student_t_distribution<_Ty>& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const negative_binomial_distribution<_Ty>& _Left,
...
template<class _Ty>
_NODISCARD bool operator==(const discrete_distribution<_Ty>& _Left,
...
{	// piecewise constant floating-point distribution
public:
...
template<class _Ty>
_NODISCARD bool operator==(const piecewise_constant_distribution<_Ty>& _Left,
...
class piecewise_linear_distribution
	: public discrete_distribution<size_t>
{	// piecewise linear floating-point distribution
public:
	...
	{	// return next value
		...
		if (_P0 != _P1)
		{
			_X0 = static_cast<result_type>((_STD sqrt(_P0 * _P0 * (1.0 - _X0)
...
template<class _Ty>
_NODISCARD bool operator==(const piecewise_linear_distribution<_Ty>& _Left,
...
public:
	...
	_NODISCARD double entropy() const _NOEXCEPT
