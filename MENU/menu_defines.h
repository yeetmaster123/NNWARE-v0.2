...
namespace MENU
{
	namespace PPGUI_PP_GUI
	{
		...
		constexpr int CHECKBOX_SIZE = 10;

		constexpr int COMBOBOX_HEIGHT = 14;
		constexpr int COMBOBOX_WIDTH = 200;
		constexpr int COMBOBOX_MAX_ITEMS_AT_ONCE = 8;

		constexpr int SLIDER_HEIGHT = 7;
		constexpr int SLIDER_WIDTH = 200;

		constexpr int TAB_PADDING = 10;
		constexpr int TAB_HEIGHT = 20;

		constexpr int VERTICAL_TAB_WIDTH = 70; // width
		constexpr int VERTICAL_TAB_HEIGHT = 64; // height of a single item
		constexpr int VERTICAL_TAB_PADDING = 27; // the padding between items
		constexpr int VERTICAL_TAB_MAX_ITEMS_AT_ONCE = 8;
		...
		constexpr int COLOR_PICKER_CLOSED_HEIGHT = 14;
...
constexpr int TAB_PADDING = 5;
constexpr int TAB_HEIGHT = 30;

constexpr int VERTICAL_TAB_WIDTH = 70; // width
constexpr int VERTICAL_TAB_HEIGHT = 10; // height of a single item
constexpr int VERTICAL_TAB_PADDING = 8; // the padding between items
constexpr int VERTICAL_TAB_MAX_ITEMS_AT_ONCE = 8;
