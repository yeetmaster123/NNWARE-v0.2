...
namespace SETTINGS
{
	...
	public:
		...
		int M4A4Skin;
		int AUGSkin;
		float menurainbowspeed;
		int FAMASSkin;
		int AWPSkin;
		int SSG08Skin;
		float gradientspeed;
		bool gradientglow;
		bool gradientteamglow;
		bool gradientEnemyglow;
		bool gradientteamchams;
		float radgollslider = 800;
		bool gradientEnemychams;
		float transparency_when_scoped;
		bool gradient;
		bool gradientbullet;
		float gradienttracerspeed;
		bool gradientEnemyivschams;
		int Menu_theme;
		bool rageYEET;
		...
		bool freestandind;
		int box_type;
		CColor FREESTANDINGcolor;
		CColor zeusrangecolor;
		bool zeusrange;
		bool reverse_bool;
		bool multi_bool;
		bool fakefix_bool;
		...
		bool fakewalk;
		bool ragdoll_bool;
		bool ragdollteam_bool;
		float radgollteamslider = 800;
		float gradientglowspeed;
		float gradientchamsspeed;
		bool norecoil;
