...
namespace OFFSETS
{
	...
	void InitOffsets()
	{
		...
		m_dwBoneMatrix = UTILS::netvar_hook_manager.GetOffset(("DT_BaseAnimating"), ("m_dwBoneMatrix"));
		...
		dwPlayerResource = UTILS::netvar_hook_manager.GetOffset(("DT_CSPlayerResource"), ("CSPlayerResource"));
